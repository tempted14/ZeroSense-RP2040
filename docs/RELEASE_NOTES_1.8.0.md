...
output multiplier with a 2× default. It scales X and Y of the stock
estimated patterns after the per-point profile transfer limit, preserving the
source pattern and shot timing. Modified and measured profiles, plus General,
Experimental, and Research modes, do not use this multiplier.
